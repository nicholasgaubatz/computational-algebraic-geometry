...
HashTable{AOTideal => ideal (y y  - y y  - y y , y y y  - y y y  - y y y  + y y y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 3}, set {3, 5}, set {0, 5}, set {1, 4}, set {2, 4}, set {1, 5}, set {2, 5}}
                                 2      3      4     5
          hSeries => 1 + 7T + 20T  + 29T  + 21T  + 6T
          hyperplanes => {a - d, d - f, a - f, b - e, c - e, b - f, c - f}
          numVariables => 7
...
G = graph {set {0, 3}, set {3, 5}, set {0, 5}, set {1, 4}, set {2, 4}, set {1, 5}, set {2, 5}}
