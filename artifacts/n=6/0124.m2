...
HashTable{AOTideal => ideal (y y  - y y  + y y , y y  - y y  + y y , y y  - y y  + y y , y y  - y y  - y y , y y  - y y  - y y , y , y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 2}, set {2, 4}, set {2, 5}, set {0, 4}, set {0, 5}, set {1, 3}, set {1, 4}, set {1, 5}, set {4, 5}}
                                 2      3      4      5
          hSeries => 1 + 9T + 31T  + 51T  + 40T  + 12T
          hyperplanes => {a - c, c - e, c - f, a - e, a - f, b - d, b - e, b - f, e - f}
          numVariables => 9
...
G = graph {set {0, 2}, set {2, 4}, set {2, 5}, set {0, 4}, set {0, 5}, set {1, 3}, set {1, 4}, set {1, 5}, set {4, 5}}
