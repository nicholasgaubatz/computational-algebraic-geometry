...
HashTable{AOTideal => ideal (y y  - y y  - y y , y y  - y y  - y y , y y y  - y y y  - y y y  + y y y , y y y  - y y y  - y y y  + y y y , y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 3}, set {1, 3}, set {3, 5}, set {0, 4}, set {0, 5}, set {1, 4}, set {1, 5}, set {2, 5}}
                                 2      3      4      5
          hSeries => 1 + 8T + 26T  + 42T  + 33T  + 10T
          hyperplanes => {a - d, b - d, d - f, a - e, a - f, b - e, b - f, c - f}
          numVariables => 8
...
G = graph {set {0, 3}, set {1, 3}, set {3, 5}, set {0, 4}, set {0, 5}, set {1, 4}, set {1, 5}, set {2, 5}}
