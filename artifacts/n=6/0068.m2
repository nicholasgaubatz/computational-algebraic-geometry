...
HashTable{AOTideal => ideal (y y  - y y  + y y , y y  - y y  + y y , y y  - y y  - y y , y y  - y y  - y y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 3}, set {3, 4}, set {3, 5}, set {0, 4}, set {0, 5}, set {4, 5}, set {1, 5}}
                                 2      3     4
          hSeries => 1 + 7T + 17T  + 17T  + 6T
          hyperplanes => {a - d, d - e, d - f, a - e, a - f, e - f, b - f}
          numVariables => 7
...
G = graph {set {0, 3}, set {3, 4}, set {3, 5}, set {0, 4}, set {0, 5}, set {4, 5}, set {1, 5}}
