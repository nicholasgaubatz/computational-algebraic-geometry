...
HashTable{AOTideal => ideal (y y  - y y  - y y , y y  - y y  + y y , y y y y  - y y y y  - y y y y  + y y y y  + y y y y , y y y y  - y y y y  + y y y y  - y y y y  - y y y y , y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 2}, set {2, 4}, set {0, 3}, set {0, 5}, set {1, 3}, set {3, 5}, set {1, 4}, set {1, 5}}
                                 2      3      4      5
          hSeries => 1 + 8T + 26T  + 44T  + 39T  + 14T
          hyperplanes => {a - c, c - e, a - d, a - f, b - d, d - f, b - e, b - f}
          numVariables => 8
...
G = graph {set {0, 2}, set {2, 4}, set {0, 3}, set {0, 5}, set {1, 3}, set {3, 5}, set {1, 4}, set {1, 5}}
