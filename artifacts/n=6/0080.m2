...
HashTable{AOTideal => ideal (y y  - y y  - y y , y y  - y y  - y y , y y y  - y y y  - y y y  + y y y , y y y  - y y y  - y y y  + y y y , y y y  - y y y  - y y y  + y y y , y y y  - y y y  - y y y  + y y y , y y y  - y y y  - y y y  + y y y , y , y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 3}, set {3, 4}, set {3, 5}, set {0, 4}, set {0, 5}, set {1, 4}, set {2, 4}, set {1, 5}, set {2, 5}}
                                 2      3      4      5
          hSeries => 1 + 9T + 34T  + 65T  + 61T  + 22T
          hyperplanes => {a - d, d - e, d - f, a - e, a - f, b - e, c - e, b - f, c - f}
          numVariables => 9
...
G = graph {set {0, 3}, set {3, 4}, set {3, 5}, set {0, 4}, set {0, 5}, set {1, 4}, set {2, 4}, set {1, 5}, set {2, 5}}
