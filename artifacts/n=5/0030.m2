...
HashTable{AOTideal => ideal (y y  - y y  + y y , y y  - y y  + y y , y y  - y y  - y y , y y  - y y  - y y , y y y  - y y y  - y y y  + y y y , y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 2}, set {1, 2}, set {2, 4}, set {0, 3}, set {0, 4}, set {1, 3}, set {1, 4}, set {3, 4}}
                                 2      3      4
          hSeries => 1 + 8T + 24T  + 31T  + 14T
          hyperplanes => {a - c, b - c, c - e, a - d, a - e, b - d, b - e, d - e}
          numVariables => 8
...
G = graph {set {0, 2}, set {1, 2}, set {2, 4}, set {0, 3}, set {0, 4}, set {1, 3}, set {1, 4}, set {3, 4}}
