...
HashTable{AOTideal => ideal (y y  - y y  - y y , y y  - y y  + y y , y y  - y y  - y y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 2}, set {2, 4}, set {0, 3}, set {0, 4}, set {1, 3}, set {3, 4}, set {1, 4}}
                                 2      3     4
          hSeries => 1 + 7T + 18T  + 20T  + 8T
          hyperplanes => {a - c, c - e, a - d, a - e, b - d, d - e, b - e}
          numVariables => 7
...
G = graph {set {0, 2}, set {2, 4}, set {0, 3}, set {0, 4}, set {1, 3}, set {3, 4}, set {1, 4}}
