...
HashTable{AOTideal => ideal (y y  - y y  + y y , y y  - y y  + y y , y y  - y y  + y y , y y  - y y  - y y , y y  - y y  - y y , y y  - y y  - y y , y y  - y y  - y y , y , y , y , y , y , y , y , y , y , y  )}
          ...
          graph => {set {0, 4}, set {1, 4}, set {4, 5}, set {4, 6}, set {0, 5}, set {0, 6}, set {1, 5}, set {1, 6}, set {5, 6}, set {2, 6}}
                                  2      3      4      5
          hSeries => 1 + 10T + 38T  + 68T  + 57T  + 18T
          hyperplanes => {a - e, b - e, e - f, e - g, a - f, a - g, b - f, b - g, f - g, c - g}
          numVariables => 10
...
G = graph {set {0, 4}, set {1, 4}, set {4, 5}, set {4, 6}, set {0, 5}, set {0, 6}, set {1, 5}, set {1, 6}, set {5, 6}, set {2, 6}}
