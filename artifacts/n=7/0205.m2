...
HashTable{AOTideal => ideal (y y  - y y  - y y , y y  - y y  - y y , y y y  + y y y  - y y y  - y y y , y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 4}, set {1, 4}, set {4, 6}, set {0, 5}, set {1, 6}, set {2, 5}, set {5, 6}, set {2, 6}}
                                 2      3      4      5
          hSeries => 1 + 8T + 26T  + 43T  + 36T  + 12T
          hyperplanes => {a - e, b - e, e - g, a - f, b - g, c - f, f - g, c - g}
          numVariables => 8
...
G = graph {set {0, 4}, set {1, 4}, set {4, 6}, set {0, 5}, set {1, 6}, set {2, 5}, set {5, 6}, set {2, 6}}
