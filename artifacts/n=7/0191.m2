...
HashTable{AOTideal => ideal (y y y  - y y y  - y y y  + y y y , y y y  - y y y  - y y y  + y y y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 4}, set {1, 4}, set {0, 5}, set {0, 6}, set {1, 6}, set {2, 5}, set {2, 6}}
                                 2      3      4     5
          hSeries => 1 + 7T + 21T  + 33T  + 27T  + 9T
          hyperplanes => {a - e, b - e, a - f, a - g, b - g, c - f, c - g}
          numVariables => 7
...
G = graph {set {0, 4}, set {1, 4}, set {0, 5}, set {0, 6}, set {1, 6}, set {2, 5}, set {2, 6}}
