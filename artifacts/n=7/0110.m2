...
HashTable{AOTideal => ideal (y y  - y y  - y y , y y  - y y  - y y , y , y , y , y , y , y , y )       }
          ...
          graph => {set {0, 4}, set {4, 6}, set {0, 6}, set {1, 5}, set {2, 5}, set {5, 6}, set {1, 6}}
                                 2      3      4     5
          hSeries => 1 + 7T + 19T  + 25T  + 16T  + 4T
          hyperplanes => {a - e, e - g, a - g, b - f, c - f, f - g, b - g}
          numVariables => 7
...
G = graph {set {0, 4}, set {4, 6}, set {0, 6}, set {1, 5}, set {2, 5}, set {5, 6}, set {1, 6}}
