...
HashTable{AOTideal => ideal (y y  - y y   + y y  , y y  - y y   + y y  , y y  - y y   + y y  , y y  - y y  - y y , y y  - y y  - y y , y , y , y , y , y , y , y , y , y , y  )}
          ...
          graph => {set {0, 3}, set {3, 5}, set {3, 6}, set {0, 5}, set {0, 6}, set {1, 4}, set {2, 4}, set {4, 5}, set {4, 6}, set {5, 6}}
                                  2      3      4      5      6
          hSeries => 1 + 10T + 40T  + 82T  + 91T  + 52T  + 12T
          hyperplanes => {a - d, d - f, d - g, a - f, a - g, b - e, c - e, e - f, e - g, f - g}
          numVariables => 10
...
G = graph {set {0, 3}, set {3, 5}, set {3, 6}, set {0, 5}, set {0, 6}, set {1, 4}, set {2, 4}, set {4, 5}, set {4, 6}, set {5, 6}}
