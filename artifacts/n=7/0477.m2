...
HashTable{AOTideal => ideal (y y  - y y  - y y , y y  - y y  + y y , y y  - y y  - y y , y y y  - y y y  - y y y  + y y y , y y y y  - y y y y  + y y y y  - y y y y  - y y y y , y , y , y , y , y , y , y , y , y , y  )}
          ...
          graph => {set {0, 3}, set {3, 5}, set {3, 6}, set {0, 4}, set {0, 6}, set {1, 4}, set {4, 6}, set {1, 5}, set {1, 6}, set {2, 6}}
                                  2      3       4      5      6
          hSeries => 1 + 10T + 42T  + 95T  + 121T  + 81T  + 22T
          hyperplanes => {a - d, d - f, d - g, a - e, a - g, b - e, e - g, b - f, b - g, c - g}
          numVariables => 10
...
G = graph {set {0, 3}, set {3, 5}, set {3, 6}, set {0, 4}, set {0, 6}, set {1, 4}, set {4, 6}, set {1, 5}, set {1, 6}, set {2, 6}}
