...
HashTable{AOTideal => ideal (y y  - y y  - y y , y y  - y y  - y y , y y y  - y y y  - y y y  + y y y , y y y  - y y y  - y y y  + y y y , y , y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 3}, set {0, 5}, set {1, 4}, set {2, 4}, set {4, 6}, set {1, 5}, set {1, 6}, set {2, 5}, set {2, 6}}
                                 2      3      4      5      6
          hSeries => 1 + 9T + 34T  + 68T  + 75T  + 43T  + 10T
          hyperplanes => {a - d, a - f, b - e, c - e, e - g, b - f, b - g, c - f, c - g}
          numVariables => 9
...
G = graph {set {0, 3}, set {0, 5}, set {1, 4}, set {2, 4}, set {4, 6}, set {1, 5}, set {1, 6}, set {2, 5}, set {2, 6}}
