...
HashTable{AOTideal => ideal (y y  - y y  - y y , y y  - y y  - y y , y y  - y y  - y y , y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 5}, set {1, 5}, set {2, 5}, set {5, 6}, set {0, 6}, set {1, 6}, set {2, 6}, set {3, 6}}
                                 2      3      4     5
          hSeries => 1 + 8T + 25T  + 38T  + 28T  + 8T
          hyperplanes => {a - f, b - f, c - f, f - g, a - g, b - g, c - g, d - g}
          numVariables => 8
...
G = graph {set {0, 5}, set {1, 5}, set {2, 5}, set {5, 6}, set {0, 6}, set {1, 6}, set {2, 6}, set {3, 6}}
