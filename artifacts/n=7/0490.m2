...
HashTable{AOTideal => ideal (y y  - y y  - y y , y y  - y y  - y y , y y y  - y y y  - y y y  + y y y , y y y  - y y y  - y y y  + y y y , y y y  + y y y  - y y y  - y y y , y , y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 3}, set {3, 5}, set {3, 6}, set {0, 4}, set {0, 5}, set {1, 4}, set {4, 6}, set {1, 5}, set {1, 6}}
                                 2      3      4      5
          hSeries => 1 + 9T + 34T  + 67T  + 67T  + 26T
          hyperplanes => {a - d, d - f, d - g, a - e, a - f, b - e, e - g, b - f, b - g}
          numVariables => 9
...
G = graph {set {0, 3}, set {3, 5}, set {3, 6}, set {0, 4}, set {0, 5}, set {1, 4}, set {4, 6}, set {1, 5}, set {1, 6}}
