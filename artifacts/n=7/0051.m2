...
HashTable{AOTideal => ideal (y y  - y y  - y y , y y  - y y  - y y , y y  - y y  - y y , y y  - y y  - y y , y , y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 5}, set {1, 5}, set {2, 5}, set {3, 5}, set {5, 6}, set {0, 6}, set {1, 6}, set {2, 6}, set {3, 6}}
                                 2      3      4      5
          hSeries => 1 + 9T + 32T  + 56T  + 48T  + 16T
          hyperplanes => {a - f, b - f, c - f, d - f, f - g, a - g, b - g, c - g, d - g}
          numVariables => 9
...
G = graph {set {0, 5}, set {1, 5}, set {2, 5}, set {3, 5}, set {5, 6}, set {0, 6}, set {1, 6}, set {2, 6}, set {3, 6}}
