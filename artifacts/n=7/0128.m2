...
HashTable{AOTideal => ideal (y y  - y y  - y y , y y y  - y y y  - y y y  + y y y , y y y  - y y y  - y y y  + y y y , y y y  - y y y  - y y y  + y y y , y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 4}, set {4, 6}, set {0, 5}, set {0, 6}, set {1, 5}, set {2, 5}, set {1, 6}, set {2, 6}}
                                 2      3      4      5
          hSeries => 1 + 8T + 27T  + 47T  + 41T  + 14T
          hyperplanes => {a - e, e - g, a - f, a - g, b - f, c - f, b - g, c - g}
          numVariables => 8
...
G = graph {set {0, 4}, set {4, 6}, set {0, 5}, set {0, 6}, set {1, 5}, set {2, 5}, set {1, 6}, set {2, 6}}
