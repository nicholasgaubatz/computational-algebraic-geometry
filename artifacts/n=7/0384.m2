...
HashTable{AOTideal => ideal (y y  - y y  + y y , y y  - y y  + y y , y y  - y y  - y y , y y  - y y  - y y , y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 3}, set {3, 5}, set {3, 6}, set {0, 5}, set {0, 6}, set {1, 4}, set {5, 6}, set {2, 6}}
                                 2      3      4     5
          hSeries => 1 + 8T + 24T  + 34T  + 23T  + 6T
          hyperplanes => {a - d, d - f, d - g, a - f, a - g, b - e, f - g, c - g}
          numVariables => 8
...
G = graph {set {0, 3}, set {3, 5}, set {3, 6}, set {0, 5}, set {0, 6}, set {1, 4}, set {5, 6}, set {2, 6}}
