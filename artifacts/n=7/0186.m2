...
HashTable{AOTideal => ideal (y y  - y y  + y y , y y  - y y  + y y , y y  - y y  - y y , y y  - y y  - y y , y y y  - y y y  - y y y  + y y y , y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 4}, set {1, 4}, set {4, 6}, set {0, 5}, set {0, 6}, set {1, 5}, set {1, 6}, set {5, 6}}
                                 2      3      4
          hSeries => 1 + 8T + 24T  + 31T  + 14T
          hyperplanes => {a - e, b - e, e - g, a - f, a - g, b - f, b - g, f - g}
          numVariables => 8
...
G = graph {set {0, 4}, set {1, 4}, set {4, 6}, set {0, 5}, set {0, 6}, set {1, 5}, set {1, 6}, set {5, 6}}
