...
HashTable{AOTideal => ideal (y y  - y y  - y y , y y y  - y y y  - y y y  + y y y , y , y , y , y , y , y , y )}
          ...
          graph => {set {0, 4}, set {4, 6}, set {0, 6}, set {1, 5}, set {2, 5}, set {1, 6}, set {2, 6}}
                                 2      3      4     5
          hSeries => 1 + 7T + 20T  + 29T  + 21T  + 6T
          hyperplanes => {a - e, e - g, a - g, b - f, c - f, b - g, c - g}
          numVariables => 7
...
G = graph {set {0, 4}, set {4, 6}, set {0, 6}, set {1, 5}, set {2, 5}, set {1, 6}, set {2, 6}}
